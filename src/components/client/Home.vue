        ...
        <div class="background">
            <div class="row">
                ...
                <div class="col-4" style="padding-left:250px;">
                   <img src="static\images\fire.png" style="width:25px; height:25px;">
                   <h5>Tiến bộ nhanh chóng</h5>
                    <div class=" mt-0">
                ...
                <div class="col-4" style="padding-right:250px;">
                   ...
                   <h5>Truyền động lực học</h5>
                    <div class=" mt-0">
                       Chúng tôi giúp người học dễ dàng xây dựng thói quen học tập, qua những tính năng mô phỏng trò chơi, các thử thách vui vẻ, và nhắc nhở từ linh vật thân thiện - Bubble.
                    </div>
                    <img src="static\images\book.png" style="width:25px; height:25px;">
                   <h5>Học thật vui!</h5>
                    <div class=" mt-0">
